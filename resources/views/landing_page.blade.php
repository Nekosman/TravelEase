...
<body class="index-page">
    ...
    // Nomor WhatsApp tujuan (masukkan nomor WA Anda)
    let phoneNumber = '628xxxxxxxxxx'; // Ganti dengan nomor WhatsApp Anda

    // Buat URL WhatsApp dengan parameter pesan
    let whatsappUrl = `https://wa.me/${+62895358165040}?text=
