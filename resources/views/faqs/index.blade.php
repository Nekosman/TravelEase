                ...
                <div class="card shadow-lg">
                    <div class="card-header text-white" style="background-color: #366389;">
                        ...
                        <div class="float-end">
                            ...
                            <a href="{{ route('faqSubCategory.index') }}" class="btn btn-warning btn-sm">Create SubCategory</a>
                            <a href="{{ route('faq.create') }}" class="btn btn-info btn-sm me-2">Create FAQ</a>
                        </div>
